    ...
    treeD3JS.prototype.graphTree = function (config) {
        ...
        if (this.centerNode.image) {
            ...
            treeG
                ...
                .html(
                    (d) =>
                        `<i style="font-size:${fa_size * 2}px; color:${this.centerNode.faIcon.color}" class="${this.centerNode.faIcon.icon
                        }" aria-hidden="true"></i>`
                );
        } else {
            treeG
        ...
        function update(source, originalData, g, maxLength) {
            ...
            if (forUpward && originalData.name === "origin" && originalData.children && originalData.children.length !== 0) {
                if (!isOdd(originalData.children.length)) {
                    ...
                    centralChild = source.children[originalData.children.length / 2 - 0.5]; // impair
            ...
            nodes.forEach(function (d) {
                ...
                var offsetY = forUpward ? downwardSign * centerOffset - 50 : downwardSign * centerOffset;
                var lenght = 0;
